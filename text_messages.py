...
WELCOME_MESSAGE_TITLE = f"Welcome to the {ids.school_logo_white} Lisbon Discord! :raised_hands:"
WELCOME_MESSAGE_INTRO = "I'm Moulinette, and you probably know me from previous encounters. Was I too harsh with you? :robot:\n\nHere you'll be able to find motivated people to build ambitious projects with, learn a new language, or just play Among Us :video_game: but before going any further, I need to ID you!"
